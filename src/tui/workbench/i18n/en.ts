export const en = {
  ...
  'search.tip': 'search covers everything — names, descriptions, items',
  'mcp.failed': 'MCP "{name}" failed to connect — open MCP to inspect',
  ...
  'destructive.noBackup': '[u] no backup → Recovery Bin (auto-expires, 30 days)',
  'destructive.cancel': '[esc] keep it',
  'keymap.concepts': 'Concepts',
  'keymap.concept.profile': 'Profile — isolated Claude Code environment: own memory, skills, settings',
  'keymap.concept.copied': 'Copied Skill — snapshot owned by the Profile',
  'keymap.concept.linked': 'Linked Skill — shares a local source; removing never deletes it',
  'keymap.concept.backup': 'Backup — durable copy, kept until you delete it',
  'keymap.concept.bin': 'Recovery Bin — temporary holding for removals without backup',
  'keymap.concept.plugins': 'Plugins — Claude-managed; change them through Claude Code',
